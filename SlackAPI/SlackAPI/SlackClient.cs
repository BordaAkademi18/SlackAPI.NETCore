    ...
    public class SlackClient
    {
        ...
        public void ErrorHandler(string errorMessage)
        {
            switch (errorMessage)
            {
                ...
                case "bad_image": throw new Exception("The uploaded image could not be processed - try passing a JPEG, GIF or PNG");
                case "bad_timestamp": throw new Exception("Value passed for timestamp was invalid.");
                case "cannot_add_bot": throw new Exception("Reminders can't be sent to bots.");
                case "cannot_add_others": throw new Exception("Guests can't set reminders for other team members.");
                case "cannot_add_others_recurring": throw new Exception("Recurring reminders can't be set for other team members.");
                case "cannot_add_slackbot": throw new Exception("Reminders can't be sent to Slackbot.");
                case "cannot_complete_others": throw new Exception("Reminders for other team members can't be marked complete.");
                case "cannot_complete_recurring": throw new Exception("Recurring reminders can't be marked complete.");
                case "cannot_find_service": throw new Exception("A record of your app being allowed to unfurl for this workspace could not be found.");
                case "cannot_parse": throw new Exception("The phrasing of the timing for this reminder is unclear. You must include a complete time description. Some examples that work: 1458678068, 20, in 5 minutes, tomorrow, at 3:30pm, on Tuesday, or next week.");
                case "cannot_prompt": throw new Exception("The current user has already interacted with and dismissed a prompt for this application.");
                case "cannot_unfurl_url": throw new Exception("The URL cannot be unfurled. This error may be returned if you haven't acknowledged a link_shared event tied to the same URL. It is also returned when the domain appears in a workspace's administrative blacklists.");
                case "cannot_update_admin_user": throw new Exception("Only a primary owner can update the profile of an admin.");
